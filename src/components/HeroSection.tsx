      ...
      <div className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <div className="animate-fade-in-up">
          ...
          <p className="text-xl md:text-2xl text-muted-foreground mb-12 max-w-3xl mx-auto leading-relaxed">
            ...
            <span className="text-secondary font-semibold"> video editing</span>, 
            <span className="text-secondary font-semibold"> web design</span>, and 
            <span className="text-secondary font-semibold"> subtitling & quality checking</span>.
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-3xl mx-auto">
            <div className="glass-card p-6 text-center">
              <h3 className="text-lg font-bold text-secondary mb-2">Quality Content</h3>
            ...
            <div className="glass-card p-6 text-center">
              <h3 className="text-lg font-bold text-secondary mb-2">Creative & Ethical</h3>
